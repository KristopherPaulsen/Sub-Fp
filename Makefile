# This Makefile is for the Sub::Fp extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Sub/Fp.pm]
#     AUTHOR => [q[Kristopher C. Paulsen <kristopherpaulsen+cpan@gmail.com>]]
#     BUILD_REQUIRES => { Exporter=>q[0], strict=>q[0], warnings=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     LICENSE => q[artistic_2]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[Sub::Fp]
#     PL_FILES => {  }
#     PREREQ_PM => { Carp=>q[0], Exporter=>q[0], List::Util=>q[0], POSIX=>q[0], Test::Class=>q[0], Test::More=>q[0], strict=>q[0], warnings=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Sub/Fp.pm]
#     clean => { FILES=>q[Sub-Fp-*] }
...
TO_INST_PM = lib/Sub/Fp.pm

PM_TO_BLIB = lib/Sub/Fp.pm \
	blib/lib/Sub/Fp.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/Sub/Fp.pm $(INST_MAN3DIR)/Sub::Fp.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''A Clojure / Python Toolz / Lodash inspired Functional Utility Library'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Kristopher C. Paulsen <kristopherpaulsen+cpan@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Sub-Fp' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Test::Class: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "A Clojure / Python Toolz / Lodash inspired Functional Utility Library",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Kristopher C. Paulsen <kristopherpaulsen+cpan@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Sub-Fp",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Test::Class" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A Clojure / Python Toolz / Lodash inspired Functional Utility Library</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Kristopher C. Paulsen &lt;kristopherpaulsen+cpan@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::Class" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Sub/Fp.pm blib/lib/Sub/Fp.pm 
